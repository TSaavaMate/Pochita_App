...
class RecAdapterForReviewedItems(private val context: Context, private val productList:ArrayList<Product>,):
    RecyclerView.Adapter<RecAdapterForReviewedItems.ViewHolder>() {
